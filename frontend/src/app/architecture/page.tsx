    ...
    <div className="grid gap-6">
      ...
      <Card className="scanline relative overflow-hidden">
        <CardHeader>
          ...
          <CardDescription>
            Streamlined workflow from data collection to real-time climate twin visualization and
        ...
        <CardContent className="py-8">
          <div className="relative flex flex-col items-center gap-8 lg:flex-row lg:justify-between lg:gap-2">
            ...
            <div className="absolute left-6 right-6 top-1/2 z-0 hidden h-0.5 -translate-y-1/2 bg-gradient-to-r from-cyan-500/50 via-indigo-500/50 to-emerald-500/50 lg:block" />
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div
                  key={step.id}
                  className="relative z-10 flex max-w-[180px] flex-col items-center text-center"
                >
                  <div
                    className={`grid h-12 w-12 place-items-center rounded-lg border-2 ${step.color} shadow-lg transition-transform duration-300 hover:scale-110`}
                  >
      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent className="grid gap-4">
            <div className="rounded-md border border-cyan-300/15 bg-white/[0.03] p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-300">
                Uses stacked Long Short-Term Memory (LSTM) cells to capture long-term seasonal
                dependencies and antecedent precipitation indices, essential for drought progression
                forecasts.
              </p>
            </div>
            <div className="rounded-md border border-cyan-300/15 bg-white/[0.03] p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-300">
                Applies convolution filters over gridded satellite inputs (INSAT-3D LST) to learn
                multi-scale spatial temperature gradients and thermal inertia anomalies.
              </p>
            </div>
            <div className="rounded-md border border-cyan-300/15 bg-white/[0.03] p-4">
              <h4 className="font-semibold text-white">3. Spatio-Temporal Hybrid (ConvLSTM)</h4>
              <p className="mt-2 text-sm leading-relaxed text-slate-300">
                Combines 2D convolutions with sequential feedback to forecast high-resolution
                precipitation fields over the next 48-72 hours with exceptional geographical
                fidelity.
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Alignment with ISRO, MOSDAC, and Bhuvan data infrastructures.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4">
            <div className="rounded-lg border border-cyan-400/20 bg-cyan-400/5 p-4">
              ...
              <p className="mt-2 text-xs leading-relaxed text-slate-400">
                INSAT Land Surface Temperature is mapped onto ground station gridded grids via
                bi-linear scaling to maintain absolute spatial consistency.
              </p>
            </div>
            <div className="rounded-lg border border-cyan-400/20 bg-cyan-400/5 p-4">
              <h4 className="font-semibold text-cyan-200">IMD Gridded Rainfall (0.25° × 0.25°)</h4>
              <p className="mt-2 text-xs leading-relaxed text-slate-400">
                Our main target label for predictive evaluation. Historical records since 1901 are
                utilized to train regional precipitation anomaly coefficients.
              </p>
            </div>
            <div className="rounded-lg border border-emerald-400/20 bg-emerald-400/5 p-4">
              ...
              <p className="mt-2 text-xs leading-relaxed text-slate-400">
                The pipeline exports to standardized ONNX formats, ensuring seamless portability to
                centralized command centers or on-premises servers.
              </p>
            </div>
          </CardContent>
        </Card>
